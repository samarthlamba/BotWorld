...
public class ActorWorld extends World<GameObject>
{    
     ...
     */
    public ActorWorld(Grid<GameObject> grid)
    {
        super(grid);
    }
     ...
     */
    public void add(Location loc, GameObject occupant)
    {
     ...
     */
    public void add(GameObject occupant)
    {
    ...
    {
        GameObject occupant = getGrid().get(loc);
        if (occupant == null)
            return null;
