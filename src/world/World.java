...
public class World<T>
{
    ...
    /**
     * Constructs a new World based on a RatBots Grid.  
     */
    public World()
    {
        this(new RatBotsGrid<T>(DEFAULT_ROWS, DEFAULT_COLS));
        message = null;
    }

    /**
     * Constructs a new World based on the given Grid.
     * @param g the Grid to use in the World.
     */
    public World(Grid<T> g)
    {
        ...
        addGridClass("grid.RatBotsGrid");
//        addGridClass("grid.UnboundedGrid");
    }
    ...
    public void show()
    {
        if (frame == null)
        {
            frame = new RatBotsWorldFrame<T>(this);
