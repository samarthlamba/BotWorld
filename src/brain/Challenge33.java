...
public class Challenge33 extends BotBrain {
    ...
    public int chooseAction() {
     ...
     Location farm = farmBest();
        ...
        if(besideLakeN() > 1 && getNumSeeds() > 0){
         ...
         else if(besideLakeN() > 0 && getNumSeeds() >0 && besideLakeN() <4 && (goal != seed))
                {
