...
public class RatBotsColorAssigner 
{
    ...
    public static Color getAssignedColor()
    {
        ...
        switch(count) { // One more than count to include Grey.
            ...
            case 5: return new Color(0, 98, 209);       // Bright Blue
            case 2: return new Color(48, 162, 48);      // Green
            case 3: return new Color(252, 241, 25);     // Yellow
            case 4: return new Color(124, 45, 155);     // Purple
            case 6: return new Color(255, 165, 0);    // Orange  
            case 7: return new Color(255, 105, 180);      // Hot Pink
            case 8: return new Color(139, 69, 19);      // Brown
            case 14: return new Color(123,234,45);      // Lime Green
            case 9: return new Color(0,202,222);      // Turquoise
            case 10: return new Color(255, 255, 255);      // White
            case 12: return new Color(45, 42, 145);      // Navy Blue
            case 13: return new Color(120, 120, 120);      // Gray
            case 11: return new Color(0, 0, 0);      // Black
